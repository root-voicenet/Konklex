...
public abstract class Character {
	...
	public void resetMeleeSet() {
		final List<CombatListener> listeners = meleeSet.getListeners();
		meleeSet = new MeleeSet(this); combat = false;
		for (CombatListener listener : listeners) {
			meleeSet.addListener(listener);
		}
	}
