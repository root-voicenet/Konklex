...
public abstract class Character {
	...
	/**
	 * Sends an {@link Event} to either: <ul> <li>The client if this {@link Character} is a {@link Player}.</li> <li>The AI routines if this {@link Character} is an NPC</li> </ul>
	...
	public void setHealth(int health) {
		getSkillSet().setSkill(Skill.HITPOINTS, new Skill(getSkillSet().getSkill(Skill.HITPOINTS).getExperience(), health, getHealthMax()));
	}
