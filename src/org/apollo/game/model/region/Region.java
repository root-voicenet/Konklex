...
public final class Region {
	 ...
	 */
	 ...
	 public void addItem(GroundItem item) {
		 synchronized (this) {
			 if (items.add(item)) {
				 addEvent(new CreateGroundEvent(item));
			 }
		 }
	 }
	 ...
	 public void addObject(GameObject object) {
		 synchronized (this) {
			 if (objects.add(object)) {
				 addEvent(new CreateObjectEvent(object)); 
			 }
		 }
	 }
	 ...
	 public boolean isEmpty() {
		 if (players.isEmpty() && npcs.isEmpty() && objects.isEmpty() && items.isEmpty() && staticObjects.isEmpty() && events.isEmpty()) {
			 return true;
		 }
		 return false;
	 }
	 ...
	 /**
	  * Removes this region if necessary.
	  */
