...
public final class Player extends Character {
	...
	public void exit() {
		...
		FrontendService frontendService = world.getContext().getService(FrontendService.class);
		MinigameService minigameService = world.getContext().getService(MinigameService.class);
	...
	private void sendInitialEvents() {
		...
		Prayer.clearPrayers(this, false);
	...
	public void startFarming() {
		if (!farming) {
			allotment = new Allotments(this);
			flowers = new Flowers(this);
			compost = new Compost(this);
			herbs = new Herbs(this);
			hops = new Hops(this);
			bushes = new Bushes(this);
			specialPlantOne = new SpecialPlantOne(this);
			specialPlantTwo = new SpecialPlantTwo(this);
			seedling = new Seedling(this);
			fruitTree = new FruitTree(this);
			farming = true;
	...
	/**
	 * Sets the region update flag.
	 * @return True if region update required, false if otherwise.
	 */
	public boolean isRegionUpdateRequired() {
		return regionUpdate;
	}

	/**
	 * Sets the region update.
