...
public final class Request {
	...
	public boolean hasTimedOut(int timeoutLength) {
		if (state != State.TIMED_OUT) {
			boolean timedOut = (System.currentTimeMillis() - timeCreated) >= timeoutLength;
			if (timedOut) {
	...
	public String toString() {
		return "Request[Type: " + type + " Player: " + player + " Recipent: " + recipient + "Time sent: " + timeCreated + " State: " + state + "]";
	}
}