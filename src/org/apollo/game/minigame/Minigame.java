...
public abstract class Minigame {
	 ...
	 */
	private ArrayList<MinigameListener> listeners = new ArrayList<MinigameListener>();
	...
	public int getTeam(Player player) {
		for (Entry<Integer, ArrayList<Player>> kv : players.entrySet()) {
