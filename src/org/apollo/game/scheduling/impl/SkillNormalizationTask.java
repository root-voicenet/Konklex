...
/**
 * A {@link ScheduledTask} which normalizes the skills of a player: gradually brings them back to their normal value as specified by the experience.
 * @author Graham
 */
public final class SkillNormalizationTask extends ScheduledTask {
	...
	@Override
	public void execute() {
		if (!character.isActive()) { // TODO is this check okay for this? an NPC
