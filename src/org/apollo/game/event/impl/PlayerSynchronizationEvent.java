...
public final class PlayerSynchronizationEvent extends Event {
	 ...
	 */
	public PlayerSynchronizationEvent(Player player, Position lastKnownRegion, Position position, boolean regionChanged, SynchronizationSegment segment, int localPlayers,
