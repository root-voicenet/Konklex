...
/**
 * An {@link EventHandler} which handles the skill interface clicking.
 * @author Steve
 */
public final class SkillInterfaceButtonEventHandler extends EventHandler<ButtonEvent> {
	...
	/**
	 * Displays the woodcutting screen.
	 * @param screen The screen.
	 */
