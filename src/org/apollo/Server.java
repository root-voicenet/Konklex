...
public final class Server {
	...
	/**
	 * The {@link ExecutorService} used for network events. The named thread factory is unused as Netty names threads itself.
	 */
	...
	public void loadSigar() {
		try {
			...
			Runtime.getRuntime().load(new File(".").getCanonicalPath() + seperator + "data" + seperator + "library" + seperator + (isWindows() ? "sigar.dll" : "sigar.so"));
		} catch (Exception e) {
