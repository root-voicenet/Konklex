...
public final class UpdateService extends Service {
	...
	public UpdateService() {
		final int totalThreads = REQUEST_TYPES * THREADS_PER_REQUEST_TYPE;
	...
	@Override
	public void start() {
		final int release = getContext().getRelease().getReleaseNumber();
		try {
			final File base = new File("./data/fs/" + release + "/");
