...
/**
 * An interface which may be extended by others which are capable of loading players. For example, implementations might include text-based, binary and SQL loaders.
 * @author Graham
 */
