...
public final class NpcSpawnParser {
	...
	public Npc[] parse() throws IOException, SAXException {
		...
		for (XmlNode npcNode : rootNode) {
			...
			XmlNode nodeZ = posNode.getChild("height");
			if (nodeZ != null) {
				int height = Integer.parseInt(nodeZ.getValue());
