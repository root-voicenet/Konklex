...
public final class Release317 extends Release {
	 ...
	 */
	public Release317() {
		super(317, PacketMetaDataGroup.createFromArray(PACKET_LENGTHS), PacketMetaDataGroup
				.createFromArray(API_PACKET_LENGTHS));
		init();
	}
	...
	private void init() {
		...
		register(RegionUpdateEvent.class, new RegionUpdateEventEncoder());
