...
public final class GamePacketDecoder extends StatefulFrameDecoder<GameDecoderState> {
	...
	/*
	 * (non-Javadoc)
	 * @see org.apollo.util.StatefulFrameDecoder#decode(org.jboss.netty.channel.ChannelHandlerContext, org.jboss.netty.channel.Channel, org.jboss.netty.buffer.ChannelBuffer,
	 * java.lang.Enum)
	 */
	@Override
	...
	/**
	 * Decodes a zero length packet. This hackery is required as Netty will throw an exception if we return a frame but have read nothing!
	 * @param ctx The channel handler context.
	 * @param channel The channel.
	 * @param buffer The buffer.
	 * @return The frame, or {@code null}.
