...
/**
 * Manages events which will be run in the future. Has its own thread since some events may need to be ran faster than the cycle time in the main thread.
 * @author Graham
 */
public class EventManager implements Runnable {
	...
	/**
	 * The waitFor variable is multiplied by this before the call to wait() is made. We do this because other events may be executed after waitFor is set (and take time). We may
	 * need to modify this depending on event count? Some proper tests need to be done.
	 */
