...
/**
 * The {@link PluginContext} contains methods a plugin can use to interface with the server, for example, by adding {@link EventHandler}s to {@link EventHandlerChain}s.
 * @author Graham
 */
