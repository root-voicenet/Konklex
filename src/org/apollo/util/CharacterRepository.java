...
public final class CharacterRepository<T extends Character> implements Iterable<T> {
	 ...
	 * @return {@code true} if the character was added, {@code false} if the size has reached the capacity of this repository.
	 */
	 ...
	 * @return {@code true} if the character was removed, {@code false} if it was not (e.g. if it was never added or has been removed already).
	 */
