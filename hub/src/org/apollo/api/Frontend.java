...
/**
 * A {@link Frontend} is a distinct client version, for example 317 is a common release used in server emulators.
 * @author Graham
 * @author Steve
 */
public final class Frontend {
	 ...
	 */
	public static final int[] PACKET_LENGTHS = { 0, 16, 11, -1, 34, 0, 0, 0, 0, 0,// 0
