 ...
 * @author Steve
 */
public class ReceiveFriendMethod extends Method {
	 ...
	 */
	public ReceiveFriendMethod(String sender, String friend) {
	 ...
	 * @param friend The friend.
	 */
	public ReceiveFriendMethod(long sender, long friend) {
		this.sender = sender;
		this.friend = friend;
	}
