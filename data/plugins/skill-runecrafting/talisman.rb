...
append_talisman 2455, 7130, Altar.new(1440, 5535, Position.new(3306, 3474), Position.new(2655, 4831)) # Earth
append_talisman 2456, 7129, Altar.new(1442, 5537, Position.new(3313, 3255), Position.new(2577, 4845)) # Fire
append_talisman 2484, 7132, Altar.new(1454, 5539,                      nil, Position.new(2162, 4833)) # Cosmic
append_talisman 2486, 7133, Altar.new(1462, 5541,                      nil, Position.new(2400, 4835)) # Nature
append_talisman 2487, 7134, Altar.new(1452, 5543,                      nil, Position.new(2268, 4842)) # Chaos
append_talisman 2485, 7135, Altar.new(1458, 5545,                      nil, Position.new(2400, 4835)) # Law
append_talisman 2488, 7136, Altar.new(1456, 5547,                      nil, Position.new(2208, 4831)) # Death
