...
class Death < ScheduledTask
  ...
  def release
    character.get_melee_set.get_attacker.stop_facing
    character.get_melee_set.set_attacker nil
    killer.get_melee_set.get_attacker.stop_facing
    killer.get_melee_set.set_attacker nil
  end
