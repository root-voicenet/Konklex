...
public class TileMap {
	 ...
	 */
	public static final Tile EMPTY_TILE = new Tile(Tile.NORTH_TRAVERSAL_PERMITTED | Tile.EAST_TRAVERSAL_PERMITTED
			| Tile.SOUTH_TRAVERSAL_PERMITTED | Tile.WEST_TRAVERSAL_PERMITTED);
