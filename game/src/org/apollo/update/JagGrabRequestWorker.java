 ...
 * @author Graham
 */
public final class JagGrabRequestWorker extends
RequestWorker<JagGrabRequest, ResourceProvider> {
	 ...
	 *            The file system.
	 */
	public JagGrabRequestWorker(UpdateDispatcher dispatcher,
	 ...
	 */
	@Override
	protected void service(ResourceProvider provider, Channel channel,
